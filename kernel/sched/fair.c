 ...
 */
unsigned int sysctl_sched_min_granularity = 1562500ULL;
unsigned int normalized_sysctl_sched_min_granularity = 1562500ULL;
 ...
 */
unsigned int sysctl_sched_wakeup_granularity = 12500000UL;
unsigned int normalized_sysctl_sched_wakeup_granularity = 12500000UL;
